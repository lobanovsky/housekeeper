...
class AccountTest {
    ...
    fun findAccountFromPurpose1() {
        ...
        assert(getAccount(fromName = "ПАО \"Банк ПСБ\"  г. Ярославль", purpose = "УИП///00000000001110872206 Оплата коммунальных услуг ЛС: 0000700122 Оплата через А3 т.(495)697-87-38, начать получать реестр a-3.ru/pa/") == "0000700122")
    }
