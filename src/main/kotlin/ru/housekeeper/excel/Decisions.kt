...
import ru.housekeeper.utils.QUORUM
...
private fun createPercentageSheet(workBook: Workbook, sheetName: String, decisions: List<Decision>) {
    ...
    val descriptionOfQuestions = mapOf(
        ...
        5 to "Фин.отчёт 2025",
        6 to "Фин.план 2026",
        7 to "Правила пропускного режима",
        8 to "Консьерж 325₽/мес -> 350₽/мес",
        9 to "Тревожная кнопка 1.1₽ с кв.м.",
        10 to "Содержание и ремонт 60₽ с кв.м.",
        11 to "Запрет на установку видеонаблюдения",
        12 to "Перегородки",
        13 to "Хранение бланков",
    )
