...
import ru.tsn.housekeeper.docs.DocFileService
import ru.tsn.housekeeper.docs.SimpleDocFileService
import ru.tsn.housekeeper.model.entity.Decision
import ru.tsn.housekeeper.model.entity.Room
import ru.tsn.housekeeper.parser.AnswerParser
import ru.tsn.housekeeper.repository.DecisionRepository
import ru.tsn.housekeeper.utils.logger
import ru.tsn.housekeeper.utils.yyyyMMddHHmmssDateFormat
...
class DecisionService(
    ...
    fun sendDecisions(templateId: Long, getDecisions: () -> List<Decision>): MailingInfo {
        ...
        getDecisions.invoke().forEach { decision ->
            ...
            val file = SimpleDocFileService().doIt(decision.blank.split("\n"))
